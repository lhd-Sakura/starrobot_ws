...
if("TRUE" STREQUAL "TRUE")
  set(imu_calib_SOURCE_PREFIX /home/star/starrobot_ws/src/starrobot/imu_calib)
  set(imu_calib_DEVEL_PREFIX /home/star/starrobot_ws/devel)
  ...
  set(imu_calib_INSTALL_PREFIX /home/star/starrobot_ws/install)
...
if(NOT "/home/star/starrobot_ws/src/starrobot/imu_calib/include;/usr/include/eigen3 " STREQUAL " ")
  set(imu_calib_INCLUDE_DIRS "")
  set(_include_dirs "/home/star/starrobot_ws/src/starrobot/imu_calib/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_calib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/star/starrobot_ws/src/starrobot/imu_calib/${idir}'.  ${_report}")
    endif()
...
set(depends "cmake_modules;roscpp;sensor_msgs;starrobot_msgs")
