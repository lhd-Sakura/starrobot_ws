...
from starrobot_calib.cfg import CalibrateAngularConfig
import tf
from math import radians, copysign
from starrobot_calib.transform_utils import quat_to_angle, normalize_angle
...
class CalibrateAngular():
    def __init__(self):
        ...
        self.odom_angular_scale_correction = rospy.get_param('~angular_scale', 1.0)
        ...
        while not rospy.is_shutdown():
            if self.start_test:
                ...
                while abs(error) > self.tolerance and self.start_test:
                    ...
                    move_cmd = Twist()
		    params_angle = params_x = {'current_robot_angle': turn_angle*180.0/3.141592}
                    dyn_client.update_configuration(params_angle)
    ...
    def dynamic_reconfigure_callback(self, config, level):
        ...
        self.odom_angular_scale_correction = config['angular_scale']
