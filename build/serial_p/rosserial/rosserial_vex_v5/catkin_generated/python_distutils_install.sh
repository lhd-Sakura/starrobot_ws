...
echo_and_run cd "/home/star/starrobot_ws/src/serial_p/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/star/starrobot_ws/build/serial_p/rosserial/rosserial_vex_v5" \
    install \
    $DESTDIR_ARG \
